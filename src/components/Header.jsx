...
export default function Header() {
  const wordStyle = "text-3xl font-bold text-white px-2 rounded-md sm:text-4xl";
  const counterStyle =
    "font-bold text-white px-1 rounded-md sm:text-sm sm:px-2";
  const navBtnStyle =
    "px-3 py-2 rounded border text-white hover:bg-blue-700 sm:px-6 outline-none";

  return (
    <header className="border h-20 px-2 bg-indigo-500 flex items-center justify-between md:px-5 lg:px-20">
      <div>
        <h2>
